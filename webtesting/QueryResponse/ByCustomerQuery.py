...
class TestCustomerQuery(unittest.TestCase):
    ...
    def test_edit_query(self):
        ...
        # Click on the ByCustomerQuery button
        driver.find_element(By.XPATH, "//ul[@class='dropdown-menu show']//a[@class='dropdown-item'][normalize-space()='ByCustomerQuery']").click()
        time.sleep(3)
        ByCustomerQuery_message = driver.find_element(By.XPATH, "//h1[normalize-space()='ByCustomerQuery']")
        self.assertIsNotNone(ByCustomerQuery_message, "ByCustomerQuery")
        ...
        print("test case successfully executed for ByCustomerQuery_message")
        driver.save_screenshot("ByCustomerQuery_message screenshot.png")
