...
class TestCustomerQuery(unittest.TestCase):
    ...
    def test_edit_query(self):
        ...
        driver.find_element(By.XPATH, "//ul[@class='dropdown-menu show']//a[@class='dropdown-item'][normalize-space()='Edit']").click()
        time.sleep(3)
        ...
        print("test case successfully executed for editing a query")
        driver.save_screenshot("Edit_Query screenshot.png")
