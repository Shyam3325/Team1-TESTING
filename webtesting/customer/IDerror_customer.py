...
class TestCreateCustomerFeature(unittest.TestCase):
    ...
    def test_create_new_customer(self):
        ...
        CID = driver.find_element(By.XPATH, "//input[@id='CustomerID']")
        CID.send_keys("jo_jacob")
        CID.send_keys(Keys.ENTER)
        time.sleep(2)
        IDerror_message = driver.find_element(By.XPATH, "//span[@id='CustomerID-error']")
        self.assertIsNotNone(IDerror_message, "CustomerID must be 10 characters")
        print(IDerror_message)
        ...
        print("test case successfully executed for IDerror customer")
        driver.save_screenshot("IDerror_customer screenshot.png")
